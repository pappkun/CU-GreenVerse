...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white text-slate-900 dark:bg-white dark:text-slate-900">
      <Navbar />
          ...
          <div className="container mx-auto px-4 text-center">
            ...
            <h1 className="mt-8 text-5xl md:text-6xl font-semibold tracking-tight max-w-4xl mx-auto leading-tight text-slate-900">
              ...
              <span className="block text-emerald-700 mt-2">
                {lang === "th"
                  ...
                  : "towards a giant leap for our planet"}
              </span>
            </h1>
            ...
            <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link href="/login">
                <Button
                  size="lg"
                  className="rounded-full h-14 px-8 text-lg w-full sm:w-auto shadow-lg shadow-emerald-200/60"
                >
                  {lang === "th"
              ...
              <Link href="#features">
                <Button
                  size="lg"
                  variant="outline"
                  className="rounded-full h-14 px-8 text-lg w-full sm:w-auto border-emerald-200 text-slate-700 hover:border-emerald-300 hover:text-slate-900"
                >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center divide-y md:divide-y-0 md:divide-x border-border">
              <div className="py-4">
                ...
                <p className="text-muted-foreground font-medium">
                  {lang === "th"
                    ? "นิสิตและบุคลากรที่เข้าร่วม"
                    : "Students & Staff Joined"}
                </p>
              </div>
              <div className="py-4">
          ...
          <div className="container mx-auto px-4">
            <div className="text-center max-w-3xl mx-auto mb-16">
              <h2 className="text-3xl md:text-4xl font-bold mb-4">
                {lang === "th" ? "ระบบทำงานอย่างไร" : "How it Works"}
              </h2>
              <p className="text-lg text-muted-foreground">
                {lang === "th"
                  ? "เปลี่ยนกิจวัตรประจำวันของคุณให้เป็นผลลัพธ์ทางสิ่งแวดล้อมที่วัดผลได้ผ่าน Gamification"
                  : "Turn your daily routines into measurable environmental impact through gamification."}
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <FeatureCard
                ...
                description={
                  lang === "th"
                    ? "บันทึกกิจกรรมรักษ์โลกของคุณ เช่น การใช้บริการ POP-BUS การแยกขยะ หรือการนำแก้วน้ำส่วนตัวมาเอง"
                    : "Log your eco-friendly activities like taking POP-BUS, recycling, or bringing your own cup."
                }
              />
              <FeatureCard
                ...
                description={
                  lang === "th"
                    ? "ดูผลกระทบจากการกระทำของคุณแบบเรียลไทม์ ซึ่งแปลงเป็นกิโลกรัมคาร์บอน (kgCO₂e) ที่ช่วยลดให้แก่มหาวิทยาลัย"
                    : "See your real-time impact translated to kgCO₂e saved for the university."
                }
              />
              <FeatureCard
