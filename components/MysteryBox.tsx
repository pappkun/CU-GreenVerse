...
const MYSTERY_POOL = [
  {
    name: "ส่วนลด True Coffee 30 บาท",
    rarity: "common",
  ...
  {
    name: "ส่วนลด 100 บาท ร้านอาหาร Green Zone",
    rarity: "epic",
    color: "text-purple-500",
    bg: "bg-purple-500/10",
    credits: 1200,
  ...
  {
    name: "Grand Prize: ทริป Eco Tour",
    rarity: "legendary",
      ...
      >
        ...
        {canAfford && (
          <>
            ...
            <Star
              className="absolute top-4 left-4 h-2 w-2 sm:h-3 sm:w-3 text-amber-300 animate-pulse"
              style={{ animationDelay: "0.5s" }}
            />
            <Sparkles
              className="absolute bottom-4 left-5 h-2 w-2 sm:h-3 sm:w-3 text-orange-400 animate-pulse"
        ...
        <div className="relative mb-2 sm:mb-4">
          <div
            className={`h-16 w-16 sm:h-24 sm:w-24 rounded-2xl bg-gradient-to-br from-amber-400 to-orange-500 flex items-center justify-center shadow-lg
        ...
        <h3 className="font-bold text-sm sm:text-base mt-2 sm:mt-3 leading-tight text-center">
          Green Capsule
        </h3>
        ...
        <div className="mt-auto pt-3 flex items-center gap-1 sm:gap-1.5 text-[11px] sm:text-sm font-bold text-amber-600 dark:text-amber-400">
          ...
          {MYSTERY_BOX_COST.toLocaleString()}{" "}
        ...
        <DialogContent className="sm:max-w-md text-center overflow-hidden">
          ...
          <div className="flex flex-col items-center justify-center py-6 gap-6 min-h-[260px]">
            ...
            {phase === "opening" && (
              <div className="flex flex-col items-center gap-4">
                <div
                  ...
                  style={{
                    animation:
                      "pop 0.6s cubic-bezier(0.36, 0.07, 0.19, 0.97) forwards",
                  }}
                >
            ...
            {phase === "revealed" && prize && (
              <div className="flex flex-col items-center gap-4 w-full animate-in zoom-in-75 duration-500">
                ...
                <div
                  className={`h-24 w-24 rounded-2xl ${prize.bg} flex items-center justify-center shadow-lg ring-4 ${
                    prize.rarity === "legendary"
